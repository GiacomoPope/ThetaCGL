...
class ThetaCGLDim3(CGL):
    ...
    def eval_F2(x000,x001,x010,x011,x100,x101,x110,x111):
        ...
        F = (8192) * x111 * x101 * x100 * x000 * (-x000*x010 - x001*x011 + x100*x110 + x101*x111) * (-x000*x010 + x001*x011 - x100*x110 + x101*x111) * (x000*x010 - x001*x011 - x100*x110 + x101*x111) * (x000*x010 + x001*x011 + x100*x110 + x101*x111) * (-x001*x010*x101*x110 + x000*x011*x100*x111) * (-x000**3*x011**3 + 2*x000*x001**2*x011*x100**2 - 2*x001*x010**3*x101*x111 + x000*x011*x100**2*x111**2)
        return F
    ...
    def eval_F(x0,x1,x2,x3,x4,x5,x6,x7):
        ...
        c6 = x6**2
        c7 = x7**2
        a0,a1,a2,a3,a4,a5,a6,a7 = ThetaCGLDim3.hadamard(c0,c1,c2,c3,c4,c5,c6,c7)
    ...
    def last_sqrt_slow(self,y0,y1,y2,y3,y4,y5,y6,y7,x0,x1,x2,x3,x4,x5,x6):
