    ...
    () => {
        ...
        impl Fp2 {
            ...
            */
            ...
            #[inline]
            pub fn set_select(&mut self, a: &Self, b: &Self, ctl: u64) {
            ...
            */
            ...
            pub fn condswap(a: &mut Self, b: &mut Self, ctl: u32) {
                let c = (ctl as u64) | ((ctl as u64) << 32);
                Fp::condswap(&mut a.x0, &mut b.x0, c);
                Fp::condswap(&mut a.x1, &mut b.x1, c);
            }
            ...
            pub fn set_sqrt(&mut self) -> u64 {
                ...
                let x0odd = ((self.x0.encode()[0] as u64) & 1).wrapping_neg();
                let x1odd = ((self.x1.encode()[0] as u64) & 1).wrapping_neg();
